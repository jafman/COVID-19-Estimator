const covid19ImpactEstimator = (data) => {
  ...
  const hospitalBedsByRequestedTime = Math.floor(0.35 * totalBed) - severeCasesByRequestedTime + 1;

  const svrBedsByRequestedTime = Math.floor(0.35 * totalBed) - svrSevereCasesByRequestedTime + 1;
